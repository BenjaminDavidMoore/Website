...
export const SIDE_PROJECTS: SideProject[] = [
  ...
  },
  {
    id: 'tin',
    name: 'Tin',
    tagline: 'Custom Cocktail Library',
    status: 'shipped',
    hook: 'Identify resturant recipies, curate a library of your favorites, customize with only what you have in your bar',
    body: 'I love making custom cocktails, and product building. Tin helps you pull recipies from resturant ingredient lists, using known ratios to estimate the recipies. Then you can try them out at home filtering drinks by what ingredients you have or what you can substitute with. Making experimenting with new recipies a whole lot easier. ',
    stack: ['Swift'],
  },
  {
    id: 'repitition',
    name: 'Repitition',
    tagline: 'Workout accountability for the externally-motivated',
    status: 'shipped',
    hook: 'My take on a simple workout app. Just get moving for 20 minutes a day',
    body: 'Leveraging external accountability with text-based workout sharing, multiple daily reminder notifications with persistent background activity reminders, and an emphasis on low-friction, dead simple workouts I can do anywhere, this app has helped me be the most consistent I have ever been with working out',
    stack: ['Swift'],
  },
  {
    id: 'kumiko',
